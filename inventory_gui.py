...
class InventoryWindow(QMainWindow):
    def __init__(self):
        ...
        self.btn_insert.setStyleSheet("background-color: lightgreen; color: black; font-weight: bold;")
        self.btn_update = QPushButton("수정")
        self.btn_update.setStyleSheet("background-color: orange; color: black; font-weight: bold;")
        self.btn_delete = QPushButton("삭제")
        self.btn_delete.setStyleSheet("background-color: red; color: black; font-weight: bold;")
